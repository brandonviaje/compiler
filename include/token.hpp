...
namespace semp
{
    ...
    inline const char *to_string(TokenType type)
    {
        switch (type)
        {
            case TokenType::_IDENTIFIER:    return "IDENTIFIER";
            case TokenType::_RETURN:        return "RETURN";
            case TokenType::_INT_LITERAL:   return "INT_LITERAL";
            case TokenType::_STR_LITERAL:   return "STR_LITERAL";
            case TokenType::_LEFT_BRACE:    return "LEFT_BRACE";
            case TokenType::_RIGHT_BRACE:   return "RIGHT_BRACE";
